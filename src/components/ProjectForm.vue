<template>
    <div class="w-full h-full mx-auto text-center py-4 text-green-500">
        <form @submit.prevent="onSubmit">
            <input type="text" v-model="form.name" class="bg-inherit dark:text-slate-200 text-slate-800 outline-none open-sans w-full px-10 text-center" placeholder="Create a new project">
        </form>
