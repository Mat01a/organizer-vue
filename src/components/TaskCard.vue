<template>
    <div class="bg-slate-700 rounded-md overflow-hidden shadow-md dark:text-slate-200">
        ...
        <!-- DATE -->
        <div class="py-[2px] px-2 w-min m-2 rounded-md open-sans text-slate-700 float-left" :class="{'bg-yellow-500': !task.status, 'bg-green-500': task.status}">
            <div>
                    {{ task.created }}
            </div>
        </div>
        ...
        <!-- CREATOR USERNAME -->
        <div class="my-auto py-2 px-2 float-left">
