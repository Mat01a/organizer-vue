<template>
    <div class="w-full min-h-screen dark:bg-slate-500">
        <div class="flex flex-row content-center justify-center h-min py-10">
            <div class="md:basis-1/3 basis-9/12">
                ...
                <div class="w-full h-min dark:bg-slate-700 rounded-2xl lato md:text-2xl dark:text-slate-200 p-12 drop-shadow-xl">
                    <form @submit.prevent="onSubmit">
                        <div class="w-10/12 mx-auto">
                            ...
                            <input type="text" id="username" v-bind:class="{'outline outline-1 outline-red-500': user.register_message_error.username}" class="text-xl md:mt-2 rounded-md w-full bg-slate-500 mb-8 md:p-2 dark:focus:outline-none drop-shadow-xl" v-model="form.username" required/>
